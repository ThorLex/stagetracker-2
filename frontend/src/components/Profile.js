...
import React from 'react';
  import "./dash.css"
  import user from "./../assets/img/team/profile-picture-2.jpg"
 ...
 <div>
  ...
  <div className="row">
    <div className="col-xl-5">
      ...
      <div class="card">
            <div class="card-body">
              <h5 class="card-title">Gestion du mot de passe </h5>
  ...
  <div className="row mb-3">
    ...
    <div className="col-12">
      <input type="text" className="form-control" id="inputText" placeholder='veuillez entrer votre mpot- de passe' />
    </div>
  </div>
